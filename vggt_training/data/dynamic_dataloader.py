...
class DynamicTorchDataset(ABC):
    def __init__(
        ...
        num_batches_epoch: int = 1000_000,
...
class DynamicBatchSampler(Sampler):
        ...
        while True:
            try:
                ...
                if self.is_training:
                    ...
                    batch_size = 1 # validation we using original size, therefore batch size = 1
    ...
    def __len__(self):
        # default 1000k batches every epoch
        if self.num_batches_epoch:
            return self.num_batches_epoch
        return 1000000
