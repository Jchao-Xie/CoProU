### copy from https://github.com/fzhiheng/RoGS/blob/main/datasets/nusc.py
...
if __name__ == "__main__":
    ...
    cached_K = None
    root_out = "/home/stud/xiji/storage/slurm/nuscenes_416_256/validation"
